...
def search_ollama_models(query: str, base_url: str = "http://localhost:11434") -> List[Dict[str, Any]]:
    """
    ...
    popular_ollama = [
        ...
        "mistral", "mixtral", "phi3", "nomic-embed-text",
        "mxbai-embed-large", "gemma", "gemma:2b", "gemma:7b",
        "command-r", "command-r-plus", "qwen", "llava"
    ]
