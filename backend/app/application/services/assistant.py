...
class ConnectorAssistant:
    ...
    def suggest_connector(self, user_prompt: str) -> Dict[str, Any]:
        ...
        2. s3: { "bucket_name": "string", "prefix": "string", "endpoint_url": "string", "aws_access_key_id": "string", "aws_secret_access_key": "string" }
        3. mongodb: { "connection_string": "string", "database": "string", "collection": "string", "content_field": "string", "metadata_fields": ["string"] }
        4. sql: { "connection_string": "string", "query": "string", "content_column": "string", "metadata_columns": ["string"] }
        ...
        If you don't have enough information for some fields, use placeholders like "YOUR_BUCKET_NAME".
        """
    ...
    def _fallback_suggestion(self, prompt: str) -> Dict[str, Any]:
        ...
        if "mongo" in prompt:
            return {
                "plugin_id": "mongodb",
                "config": {"connection_string": "mongodb://localhost:27017", "database": "test", "collection": "docs", "content_field": "text"},
                "explanation": "Detected MongoDB keywords. Here is a template."
            }
        elif "s3" in prompt or "bucket" in prompt:
            return {
                "plugin_id": "s3",
                "config": {"bucket_name": "my-bucket", "aws_access_key_id": "KEY", "aws_secret_access_key": "SECRET"},
                "explanation": "Detected S3 keywords. Here is a template."
            }
        elif "sql" in prompt or "postgres" in prompt or "mysql" in prompt:
            return {
                "plugin_id": "sql",
                "config": {"connection_string": "postgresql://user:pass@localhost:5432/db", "query": "SELECT text FROM table"},
            ...
            return {
                ...
                "explanation": "Defaulting to local file system. Please provide more details for other sources."
            }
