...
class IngestionOrchestrator:
    ...
    def run(self):
        ...
        """
        msg = f"Starting ingestion for source: {self.data_source.plugin_id} (Mode: {self.execution_mode})"
        logging.info(msg)
        ...
        try:
            ...
            # Finalize
            msg = f"Ingestion completed for source: {self.data_source.plugin_id}. Total documents: {doc_count}, Total chunks: {chunk_count}"
            logging.info(msg)
